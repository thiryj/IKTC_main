...
# Transaction Table enums
TRANSACTION_TYPE_SPREAD = 'VERTICAL'
TRANSACTION_TYPE_HEDGE = 'HEDGE'
...
POSITION_TYPE_HEDGE = 'HEDGE'
POSITION_TYPES = [POSITION_TYPE_VERTICAL]
POSITION_TYPES_ACTIVE = [POSITION_TYPE_VERTICAL, POSITION_TYPE_HEDGE]
